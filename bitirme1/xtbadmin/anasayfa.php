				...
				<div id="page" class="dashboard">
						 ...
						 <div class="row-fluid">
						  ...
						  <div class="row-fluid">
							  ...
							  <a href="hesap_listele.php" class="icon-btn span3">
								 ...
								 <?php
								 $bilgi= mysql_query("SELECT * FROM odemeler where durum='1'");
                           ...
                           <div class="row-fluid">
                              <a href="yonetici_listesi.php" class="icon-btn span3">
                                 ...
                                 <div>Yöneticiler</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM yonetici where sess='0'");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                                 <span class="badge badge-warning"><?=$mevcut?></span>
                              </a>
							    ...
							    <a href="mgorus_listele.php" class="icon-btn span3">
                                 ...
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM mgorus");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                           ...
                           <a href="akses_listele.php" class="icon-btn span3">
                                 ...
                                 <div>Aksesuarlar</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM aksesuar");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                            ...
                            <a href="urun_listele.php" class="icon-btn span3">
                                 ...
                                 <div>Ürünler</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM urun");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                                 <span class="badge badge-info"><?=$mevcut?></span>
                              </a>
                     ...
                     <div class="widget" style="width:50%; margin-left:20px; float:left;">
                        ...
                        <table class="table table-hover">
                              ...
                              <tr>
							   <?php
								 $sira= mysql_query("SELECT * FROM mgorus  where durum='1' order by id desc limit 1");
								 while($sirayaz=mysql_fetch_array($sira))
								 {
								 ?>
                     ...
                     <div class="widget" style="width:50%; margin-left:20px; float:left;">
                        ...
                        <table class="table table-hover">
                              ...
                              <tr>
                                ...
                                <tr>
							   <?php
								 $sira= mysql_query("SELECT * FROM iletisim where durum='1' order by id desc limit 1");
								 while($sirayaz=mysql_fetch_array($sira))
								 {
								 ?>
					 ...
					 <div class="widget" style="width:50%; margin-left:20px; float:left;">
                        ...
                        <table class="table table-hover">
                              ...
                              <tr>
							  <?php
								 $bilgi= mysql_query("SELECT * FROM online");
								 $aktif = mysql_num_rows($bilgi);
								 ?>
							  
									<td><?=$aktif?></td>
								<?php
								 $bilgii= mysql_query("SELECT * FROM ziyaret where tarih='$tarihh'");
								 $bugun = mysql_num_rows($bilgii);
								 ?>	
									<td><?=$bugun?></td>
									
									
								<?php
								 $bilgiii= mysql_query("SELECT * FROM ziyaret ");
								 $toplam = mysql_num_rows($bilgiii);
								 ?>	
									<td><?=$toplam?></td>
