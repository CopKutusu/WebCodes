...
Bu Sistemin PHP Kodları Mücahit Topal Tarafından Yazılmıştır.
Tüm Hakları Saklıdır.

info@mucahittopal.com   -   Topal Bilişim
-->
...
if($_POST)
{
	 ...
	 $giriskontrol = mysql_query("select * from yonetici where yonetici_kullanici ='$kullanici' and yonetici_sifre ='$sifre'"); 
	 ...
	 if($durum)
	 {
		 ...
		 $son_giris=mysql_query("update yonetici set yonetici_son_giris='$tarih - $saat' where yonetici_id='$yonetici_id_sabit'");
...
<body>
  ...
  <div id="login">
  <img src="" alt="Sws - Akıllı Çöp Sistemleri" class="center" /> 
  ...
  ?>
    ...
    2018 Tüm Hakları Saklıdır.<br>  <a href="http://www.SwS.com">SwS - Akıllı Çöp Sistemi</a>
  </div>
