                  ...
                  <div class="widget box light-grey">
                     ...
                     <div class="widget-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           ...
                           <?php
						   $say =0;
						    $kategori_cek=mysql_query("select * from fotograf_galeri order by id desc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <a href="../images/fotograf_galeri/<?=$kategori_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
