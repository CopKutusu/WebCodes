...
$gitti=move_uploaded_file($kaynak,$hedef);
	...
	$haber_ekle_sorgu=mysql_query("insert into aksesuar ( 
														   adi, 
														   sira,
														   aciklama,
														   resim,
...
if($dosya=="" )
	{
		$haber_duzenle_sorgu=mysql_query("update aksesuar set adi='$adi', sira='$sira',  aciklama='$aciklama' where id='$duzenlenecek_id'");
	}
	else
	{	
		$resim_bul=mysql_fetch_array(mysql_query("select * from aksesuar where id='$duzenlenecek_id'"));
		
	
		$haber_duzenle_sorgu=mysql_query("update aksesuar set adi='$adi', sira='$sira', aciklama='$aciklama', resim='$yeni_isim' where id='$duzenlenecek_id'");
...
if($_GET['islem']=="duzenle")
{
	...
	$haber_dizi=mysql_fetch_array(mysql_query("select * from aksesuar where id = '$id'"));
