...
if($_POST['fotograf_adi'] && $_GET['islem']=="")
{
	...
	$kategori_ekle_sorgu=mysql_query("insert into fotograf_galeri ( 
														   			adi, 
														   			resim) 
														   			values ( 
																   '$fotograf_adi',
...
if($_POST['fotograf_adi'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		...
		$fotograf_duzenle_sorgu=mysql_query("update fotograf_galeri set   adi='$fotograf_adi', resim='$yeni_isim' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$fotograf_duzenle_sorgu=mysql_query("update fotograf_galeri set   adi='$fotograf_adi',    where id='$duzenlenecek_id'");
	}
